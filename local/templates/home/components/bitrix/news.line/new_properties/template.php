                ...
                <?if(is_array($arItem["PREVIEW_PICTURE"])):?>
                    ...
                    <div id="<?=$this->GetEditAreaId($arItem['ID']);?>" class="col-md-6 col-lg-4 mb-4">
                        <a href="<?= $arItem['DETAIL_PAGE_URL'] ?>" class="prop-entry d-block">
                            <figure>
                                <img src="<?= $arItem['PREVIEW_PICTURE']['SRC'] ?>" alt="<?= $arItem['PREVIEW_PICTURE']['ALT'] ?>" class="img-fluid blog-img">
                            </figure>
                            <div class="prop-text">
                                <div class="inner">
                                    <span class="price rounded"><?= GetMessage("NEW_PROPERTIES_CURRENCY")?><?= $arItem['PROPERTY_PRICE_VALUE'] ?></span>
                                ...
                                <div class="prop-more-info">
                                    <div class="inner d-flex">
                                        ...
                                        <div class="col">
                                            ...
                                            <strong><?= $arItem['PROPERTY_GARAGE_AVAILABILITY_VALUE'] ?></strong>
                                        </div>
                                    </div>
                                </div>
                            </div>
