                    ...
                    <div class="row form-group">
                        <div class="col-md-12">
                            <label class="font-weight-bold"
                                   for="login"><?= GetMessage("sys_forgot_pass_login1") ?></label>
                            <input type="text" name="USER_LOGIN" id="login" class="form-control"
                                   value="<?= $arResult["LAST_LOGIN"] ?>">
                            <input type="hidden" name="USER_EMAIL"/>
                        </div>
                        <div class="col-md-12"><?= GetMessage("sys_forgot_pass_note_email") ?></div>
                    </div>
                    <? if ($arResult["PHONE_REGISTRATION"]): ?>
                        <div class="row form-group">
                            <div class="col-md-12">
                                <label class="font-weight-bold"
                                       for="phone"><?= GetMessage("sys_forgot_pass_phone") ?></label>
                                <input type="text" name="USER_PHONE_NUMBER" id="phone" class="form-control"
                                       value="<?= $arResult["USER_PHONE_NUMBER"] ?>">
                                <input type="hidden" name="USER_EMAIL"/>
                            </div>
                            <div class="col-md-12"><?= GetMessage("sys_forgot_pass_note_phone") ?></div>
                        </div>
                    <? endif; ?>
